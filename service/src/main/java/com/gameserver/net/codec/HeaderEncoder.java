...
import com.gameserver.util.ObjectAndByte;
...
public class HeaderEncoder extends OneToOneEncoder {
  ...
  @Override protected Object encode(ChannelHandlerContext ctx, Channel channel, Object msg)
      throws Exception {
    ...
    if (header instanceof HearBeatHeader) {
      allBuffer.writeBytes(ObjectAndByte.toByteArray(header.getCmdHeader()));
      allBuffer.writeInt(1000);
